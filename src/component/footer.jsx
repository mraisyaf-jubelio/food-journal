          ...
          <Col lg={3} className="mb-3 ">
            ...
            <ul className="list-unstyled small text-muted">
              <li className="mb-2">
                ...
                the food you like.{" "}
                <a href="https://github.com/raisyaf20/food-journal" target="_blank" rel="noreferrer">
                  Github
                </a>
              </li>
            </ul>
            <div className="d-flex">
              <div style={{ width: "3rem" }}>
                <a href="https://www.instagram.com/lib.rei/" target="_blank" rel="noreferrer">
                  <img src={insta} className="img-fluid" alt="icon instagram" />
                </a>
              </div>
              <div style={{ width: "3rem" }}>
                <a href="https://www.linkedin.com/in/muhamad-raisyaf-875486246/" target="_blank" rel="noreferrer">
              ...
              <div style={{ width: "3rem" }}>
                <a href="https://www.tiktok.com/id-ID/" target="_blank" rel="noreferrer">
